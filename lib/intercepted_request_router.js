  ...
  startPlayback() {
    ...
    if (matchedInterceptor) {
      ...
      if (allowUnmocked && req instanceof ClientRequest) {
        ...
        if (req?._secondLayerOptions?.secondLayer) {
          const secondLayerOptions = req._secondLayerOptions;

          debug('Forward to second layer if bodies dont match', secondLayerOptions);
          const newReq = secondLayerOptions.secondLayer(
            secondLayerOptions.proto,
            secondLayerOptions.overriddenRequest,
            [
              secondLayerOptions.options,
              secondLayerOptions.callback
            ]);
